...
#define VIM_POWER_LED_CONTROL_MASK              0x04    /* bit 2 */
...
#define VIM_POWER_LED_CONTROL_ATTR_ID(index)        VIM##index##_POWER_LED_CONTROL
...
enum extreme7830_32ce_8de_sys_cpld_sysfs_attributes {
    ...
    VIM_POWER_LED_CONTROL_ATTR_ID(1),
    VIM_POWER_LED_CONTROL_ATTR_ID(2),
};
...
static ssize_t show_vim_power_led(struct device *dev, struct device_attribute *da,
                        char *buf);
static ssize_t show_vim_power_led_control(struct device *dev, struct device_attribute *da,
                           char *buf);
static ssize_t set_vim_power_led_control(struct device *dev, struct device_attribute *da,
                      const char *buf, size_t count);
...
/* VIM Power LED Control */
#define DECLARE_VIM_POWER_LED_CONTROL_DEVICE_ATTR(index) \
	static SENSOR_DEVICE_ATTR(vim##index##_power_led_control, S_IWUSR | S_IRUGO, show_vim_power_led_control, set_vim_power_led_control, VIM##index##_POWER_LED_CONTROL)
#define DECLARE_VIM_POWER_LED_CONTROL_ATTR(index)  &sensor_dev_attr_vim##index##_power_led_control.dev_attr.attr
...
DECLARE_VIM_POWER_LED_CONTROL_DEVICE_ATTR(1);
DECLARE_VIM_POWER_LED_CONTROL_DEVICE_ATTR(2);
...
static struct attribute *extreme7830_32ce_8de_vim1_cpld1_attributes[] = {
    ...
    DECLARE_VIM_POWER_LED_CONTROL_ATTR(1),
...
static struct attribute *extreme7830_32ce_8de_vim2_cpld1_attributes[] = {
    ...
    DECLARE_VIM_POWER_LED_CONTROL_ATTR(2),
 ...
 *      - show_vim_power_led_control   : Get VIM power LED control attribute
 *      - set_vim_power_led_control    : Set VIM power LED control attribute
 */
static ssize_t set_vim_sfp_status(struct device *dev, struct device_attribute *da,
                      const char *buf, size_t count)
{
                      ...
                      const char *buf, size_t count)
{
    ...
    switch (board_id) {
        ...
        case VIM_24YE:
            switch (attr->index) {
                /* VIM power LED control */
                case VIM1_POWER_LED_CONTROL:
                case VIM2_POWER_LED_CONTROL:
                    reg  = VIM_PORT_LED_ON_OFF_CONTROL;
                    mask = VIM_POWER_LED_CONTROL_MASK;
                    break;
                default:
                    reg  = NOT_SUPPORT;
                    break;
